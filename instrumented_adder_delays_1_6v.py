...
def plot():
    ...
    for adder_name, adder_info in adders.items():
        ax.plot(bit_distance, adder_info["data"]["delay_1.6v"],
    ...
    #plt.tight_layout()
    plt.savefig(f"instrumented_adder_delays_1_6v.pdf", bbox_inches='tight')
    #plt.savefig(f"instrumented_adder_delays_1_6v.pdf")
    plt.close(fig)
